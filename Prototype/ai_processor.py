...
class LessonPlanProcessor:
    ...
    def generate_lesson_plan_debug(self, inputs: dict) -> str:
        """Debug function to print outputs from each stage of lesson plan generation."""
        ...
        procedures = self.generate_activity_and_assessment(refined_objectives, inputs)
        print("\n=== Procedures ===")
        print(procedures)
